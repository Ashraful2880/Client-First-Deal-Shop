  ...
  return (
    <div className="drawer drawer-mobile w-full relative">
      ...
      <div className="drawer-content">
        <div>
          {!products?.length ? (
            ...
            <div className="flex mt-4 border shadow-xl p-5 mb-10 min-h-[75vh]">
              <div className="grid lg:grid-cols-5 md:grid-cols-2 sm:grid-col-1 gap-10 overflow-hidden px-5 relative">
                {products?.map((product, key) => (
                  <div key={key}>
                    <div className="border rounded-lg mx-auto bg-white py-10">
                ...
                <label
                  htmlFor="my-drawer-2"
                  className="drawer-button lg:hidden fixed top-60 left-1"
                >
                  <i className="fa-solid fa-angles-right text-2xl bg-orange-500 px-2 rounded text-white"></i>
                </label>
              </div>
            </div>
          )}
      ...
      <div className="drawer-side">
        ...
        <ul className="menu px-16 overflow-y-auto w-60 shop-menu-bg text-white text-base text-left border-t border-orange-500 font-bold">
          <li className="cursor-pointer pb-2 pt-8 border-b-2 border-transparent hover:border-orange-500 duration-300">
            All Products
          </li>
          <li
